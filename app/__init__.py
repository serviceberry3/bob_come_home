...
app = Flask(__name__, static_url_path='/home/nodog/Documents/bob/app') #name var is predefined, set to name of module in which it's used, used to load template files etc.
